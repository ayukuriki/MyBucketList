...
ActiveRecord::Schema.define(version: 2022_09_01_050803) do
  ...
  create_table "congrats", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "achieved_list_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["achieved_list_id"], name: "index_congrats_on_achieved_list_id"
    t.index ["user_id"], name: "index_congrats_on_user_id"
  end
